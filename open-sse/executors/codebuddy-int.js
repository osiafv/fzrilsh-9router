...
/**
 * CodeBuddyIntExecutor — talks to https://www.codebuddy.ai/v2/chat/completions
 *
 * CodeBuddy International is OpenAI-compatible but rejects non-stream chat requests
 ...
 */
export class CodeBuddyIntExecutor extends DefaultExecutor {
  constructor() {
    super("codebuddy-int");
  }
...
export default CodeBuddyIntExecutor;
