...
import { getCodeBuddyIntUsage } from "./usage/codebuddy-int.js";
...
const USAGE_HANDLERS = {
  ...
  "codebuddy-int": (c) => getCodeBuddyIntUsage(c.accessToken, c.apiKey, c.providerSpecificData, c.proxyOptions),
